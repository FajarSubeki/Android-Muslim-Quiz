...
import static com.example.muslimquiz.config.AppConfig.ANSWER2_HADIST;
import static com.example.muslimquiz.config.AppConfig.ANSWER_HADIST;
import static com.example.muslimquiz.config.AppConfig.BOOM_HADIST;
import static com.example.muslimquiz.config.AppConfig.CHEKQADDED_HADIST;
import static com.example.muslimquiz.config.AppConfig.CORRECTNO_HADIST;
import static com.example.muslimquiz.config.AppConfig.FIVE_HADIST;
import static com.example.muslimquiz.config.AppConfig.FOUR_HADIST;
import static com.example.muslimquiz.config.AppConfig.HINTID_HADIST;
import static com.example.muslimquiz.config.AppConfig.ID_HADIST;
import static com.example.muslimquiz.config.AppConfig.ONE_HADIST;
import static com.example.muslimquiz.config.AppConfig.QUESTION_HADIST;
import static com.example.muslimquiz.config.AppConfig.RANDOMANS1_HADIST;
import static com.example.muslimquiz.config.AppConfig.RANDOMANS2_HADIST;
import static com.example.muslimquiz.config.AppConfig.SOUND_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME11_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME12_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME13_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME14_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME2_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME3_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME4_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME8_HADIST;
import static com.example.muslimquiz.config.AppConfig.TABLE_NAME_HADIST;
import static com.example.muslimquiz.config.AppConfig.THREE_HADIST;
import static com.example.muslimquiz.config.AppConfig.TWO_HADIST;
import static com.example.muslimquiz.config.AppConfig.UID_HADIST;
import static com.example.muslimquiz.config.AppConfig.USELESSSTRING;

public class HelperHadist extends SQLiteOpenHelper {

    Context context;

    public HelperHadist(Context context) {
        super(context, AppConfig.DATABASE_NAME_HADIST, null, AppConfig.DATABASE_VERSION);
        this.context = context;
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE_HADIST);
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE2_HADIST);
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE3_HADIST);
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE4_HADIST);
        //sqLiteDatabase.execSQL(CREATE_TABLE5);
        //sqLiteDatabase.execSQL(CREATE_TABLE6);

        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE8_HADIST);
        //sqLiteDatabase.execSQL(CREATE_TABLE9);
        //sqLiteDatabase.execSQL(CREATE_TABLE10);
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE11_HADIST);
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE12_HADIST);
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE13_HADIST);
        sqLiteDatabase.execSQL(AppConfig.CREATE_TABLE14_HADIST);
    }
    ...
    public List<Integer> GetQid() {
        String coloumns[] = {CORRECTNO_HADIST};
        SQLiteDatabase db = this.getWritableDatabase();

        db.beginTransaction();
        Cursor cursor = db.query(TABLE_NAME2_HADIST, coloumns, null, null, null, null, null);
    ...
    public void deleteAllRecord() {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("delete from " + TABLE_NAME_HADIST);
        db.execSQL("delete from " + TABLE_NAME2_HADIST);
        db.execSQL("delete from " + TABLE_NAME3_HADIST);
        db.execSQL("delete from " + TABLE_NAME4_HADIST);
        //db.execSQL("delete from " + TABLE_NAME5);
        //db.execSQL("delete from " + TABLE_NAME6);
        /* db.execSQL("delete from " + TABLE_NAME7);*/
        db.execSQL("delete from " + TABLE_NAME8_HADIST);
        //db.execSQL("delete from " + TABLE_NAME9);
        //db.execSQL("delete from " + TABLE_NAME10);
        db.execSQL("delete from " + TABLE_NAME11_HADIST);
        db.execSQL("delete from " + TABLE_NAME12_HADIST);
        db.execSQL("delete from " + TABLE_NAME13_HADIST);
        db.execSQL("delete from " + TABLE_NAME14_HADIST);
        db.close();
    }
    ...
    public List getBoomId() {
        String coloumns[] = {BOOM_HADIST};
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        Cursor cursor = db.query(TABLE_NAME12_HADIST, coloumns, null, null, null, null, null);
        List<Integer> list = new ArrayList<>();
        while (cursor.moveToNext()) {
    ...
    public  List getCheckQadded() {
        String coloumns[] = {CHEKQADDED_HADIST};
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        Cursor cursor = db.query(TABLE_NAME14_HADIST, coloumns, null, null, null, null, null);
    ...
    public void addAllQuestions(ArrayList<Questions> allQuestions) {
        ...
        try {
            ...
            for (Questions question : allQuestions) {
                values.put(QUESTION_HADIST, question.getQUESTION());
                values.put(ANSWER_HADIST, question.getANSWER());
                values.put(ANSWER2_HADIST, question.getANSWER2());
                values.put(RANDOMANS1_HADIST, question.getRANDOMANS1());
                values.put(RANDOMANS2_HADIST, question.getRANDOMANS2());
                values.put(USELESSSTRING, question.getUSELESSSTRING());
                db.insert(TABLE_NAME_HADIST, null, values);
            }
            db.setTransactionSuccessful();
        } finally {
            db.endTransaction();
    ...
    public void insertCheckQadded(int id) {
        ...
        contentValues.put(CHEKQADDED_HADIST, id);
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        db.insert(TABLE_NAME14_HADIST, null, contentValues);
        db.setTransactionSuccessful();
        db.endTransaction();
        db.close();
    }
    ...
    public List<Questions> getAllOfTheQuestions() {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        String coloumn[] = {UID_HADIST, QUESTION_HADIST, ANSWER_HADIST, ANSWER2_HADIST, RANDOMANS1_HADIST, RANDOMANS2_HADIST, USELESSSTRING};
        Cursor cursor = db.query(TABLE_NAME_HADIST, coloumn, null, null, null, null, null);
    ...
    public void insertHint(int id) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(HINTID_HADIST, id);
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        db.insert(TABLE_NAME3_HADIST, null, contentValues);
        db.setTransactionSuccessful();
        db.endTransaction();
        db.close();
    }
    ...
    public List getHint() {
        String coloumns[] = {HINTID_HADIST};
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        Cursor cursor = db.query(TABLE_NAME3_HADIST, coloumns, null, null, null, null, null);
        List<Integer> list = new ArrayList<>();
    ...
    public void insertRandomNumbers(int id,int one , int two ,int three , int four , int five) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(ID_HADIST,id);
        contentValues.put(ONE_HADIST, one);
        contentValues.put(TWO_HADIST, two);
        contentValues.put(THREE_HADIST, three);
        contentValues.put(FOUR_HADIST, four);
        contentValues.put(FIVE_HADIST, five);

        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        db.insert(TABLE_NAME4_HADIST, null, contentValues);
        db.setTransactionSuccessful();
        db.endTransaction();
        db.close();
    }
    ...
    public void InsertQid(int id) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(CORRECTNO_HADIST, id);
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        db.insert(TABLE_NAME2_HADIST, null, contentValues);
        db.setTransactionSuccessful();
        db.endTransaction();
    ...
    public List<FreeHint> getRandomNumbers() {
        String coloumns[] = {ID_HADIST,ONE_HADIST,TWO_HADIST,THREE_HADIST,FOUR_HADIST,FIVE_HADIST};
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        Cursor cursor = db.query(TABLE_NAME4_HADIST, coloumns, null, null, null, null, null);
    ...
    public List getSound() {
        String coloumns[] = {SOUND_HADIST};
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        Cursor cursor = db.query(TABLE_NAME13_HADIST, coloumns, null, null, null, null, null);
        List<Integer> list2 = new ArrayList<>();
