package com.example.muslimquiz.viewpager;
...
import com.example.muslimquiz.ui.tab.Hadist.HadistEasyTab;
import com.example.muslimquiz.ui.tab.Hadist.HadistHardTab;
import com.example.muslimquiz.ui.tab.Hadist.HadistMediumTab;

public class PagerHadist extends FragmentStatePagerAdapter {
    ...
    public PagerHadist(FragmentManager fm, int[] icon, int numbOfTabs,  Context context) {
        super(fm);
