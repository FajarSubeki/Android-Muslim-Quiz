...
import com.example.muslimquiz.ui.tab.QuranHardTab;
import com.example.muslimquiz.ui.tab.QuranMediumTab;

public class PagerQuran extends FragmentStatePagerAdapter {
    ...
    public PagerQuran(FragmentManager fm, int[] icon, int numbOfTabs,  Context context ) {
        super(fm);
