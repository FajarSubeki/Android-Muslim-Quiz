...
public class QuranSlide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quran_slide);
        init();
    }
    ...
    private void init(){
        ...
        mPager.setAdapter(new PagerQuran(getSupportFragmentManager(), icon, numboftabs, getApplicationContext()));
