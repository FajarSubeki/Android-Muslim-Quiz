...
import com.example.muslimquiz.helper.quran.EasyQuranHelper;
...
public class MainGameActivity extends AppCompatActivity {
    ...
    EasyQuranHelper easyQuranHelper;
    ...
    private void init(){
        ...
        //Our database
        easyQuranHelper = new EasyQuranHelper(this);
        //make db writable
        easyQuranHelper.getWritableDatabase();
        ...
        if (easyQuranHelper.getAllOfTheQuestions().size() == 0) {
            //If not added then add the ques,options in table
            easyQuranHelper.allQuestion();
        }

        //This will return us a list of data type TriviaQuestion
        list = easyQuranHelper.getAllOfTheQuestions();
    ...
    public void gameLostPlayAgain() {
        ...
        intent.putExtra("EASYQURAN", "Medium");
    ...
    public void gameWon() {
        ...
        intent.putExtra("EASYQURAN", "Easy");
        startActivity(intent);
        finish();
    }
