...
import com.example.muslimquiz.helper.quran.MediumQuranHelper;
import com.example.muslimquiz.model.EasyQuranModel;

import java.util.Collections;
import java.util.List;

public class MainGameMediumActivity extends BaseActivity {
    ...
    MediumQuranHelper mediumQuranHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_game_medium);
    ...
    private void init(){
        ...
        //Our database
        mediumQuranHelper = new MediumQuranHelper(this);
        //make db writable
        mediumQuranHelper.getWritableDatabase();
        ...
        if (mediumQuranHelper.getAllOfTheQuestions().size() == 0) {
            //If not added then add the ques,options in table
            mediumQuranHelper.allQuestion();
        }

        //This will return us a list of data type TriviaQuestion
        list = mediumQuranHelper.getAllOfTheQuestions();
    ...
    public void gameLostPlayAgain() {
        ...
        intent.putExtra("MEDIUMQURAN", "Medium");
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(MainGameMediumActivity.this);
