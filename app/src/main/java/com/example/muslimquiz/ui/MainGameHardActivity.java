...
public class MainGameHardActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_game_hard);
    ...
    void init(){
        ...
        demoHelperClass = new Helper(getApplicationContext());
        ...
        FreeHint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(MainGameHardActivity.this);
    ...
    public void setNoOfSolvedQueText(){
        ...
        String checkPoint = String.valueOf(prefManager.getQuranHard());
        ...
        if (currentQ.getANSWER().length() + currentQ.getANSWER2().length() == y + y2) {
            ...
            if (x.equalsIgnoreCase(currentQ.getANSWER()) && x2.equalsIgnoreCase(currentQ.getANSWER2())) {
                ...
                if (qid < 1119 && qid != 179 && qid != 359 && qid != 599 && qid != 779 && qid != 899) {
                    ...
                    int sum = 10;
                    if (checkPoint == "null"){
                        prefManager.saveQuranHard(getBaseContext(), String.valueOf(sum));
                    }else if(checkPoint != null){
                        int point_uddate = Integer.parseInt(checkPoint) + Integer.parseInt(String.valueOf(sum));
                        prefManager.saveQuranHard(getBaseContext(), String.valueOf(point_uddate));
                    }
